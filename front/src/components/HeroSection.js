            ...
            <SlideInOnScroll>
                <div className='about_container'>
                    <div className='about_img_container'>
                        <div src={process.env.PUBLIC_URL + "/images/charly-flu-3.jpg"} className="me_img c-glitch me_englobe">
                            <img src={process.env.PUBLIC_URL + '/images/charly-flu-3.jpg'} alt='Profile of Charly FLU' className='me_img c-glitch_img' />
                            <img src={process.env.PUBLIC_URL + '/images/charly-flu-3.jpg'} alt='Profile of Charly FLU' className='me_img c-glitch_img' />
                            <img src={process.env.PUBLIC_URL + '/images/charly-flu-3.jpg'} alt='Profile of Charly FLU' className='me_img c-glitch_img' />
                            <img src={process.env.PUBLIC_URL + '/images/charly-flu-3.jpg'} alt='Profile of Charly FLU' className='me_img c-glitch_img' />
                            <img src={process.env.PUBLIC_URL + '/images/charly-flu-3.jpg'} alt='Profile of Charly FLU' className='me_img c-glitch_img' />
