...
function Rain() {
    ...
    return (
        <>
            ...
            {snowing && <button className={isRaining ? "rain-button active" : "rain-button"} onClick={letItRain}>
                <img src={process.env.PUBLIC_URL + "/images/rains/snow_flake.png"} alt="" />
            </button>
            }
            {leafing && <button className={isRaining ? "rain-button active" : "rain-button"} onClick={letItRain}>
                <img src={process.env.PUBLIC_URL + "/images/rains/leaf1.png"} alt="" />
            </button>
            }
            {sakuring && <button className={isRaining ? "rain-button active" : "rain-button"} onClick={letItRain}>
